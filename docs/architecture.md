...
| Publish a blog post | **Temporary debug mode:** existing project; one to three linked notebooks; at least one collected source URL; evidence traceable through those notebooks; current verification-required claims materially supported by at least one qualifying source; last action in the proposal |
