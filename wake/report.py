...
def _shared_theme_switch(page):
    ...
    css = (
        ...
        ':root{--paper:#f5f7f3;--surface:#fff;--ink:#18302a;--muted:#5d6b65;--line:#d5e0d9;--green:#176f60;--accent:#d85a38;--hot:#a5422d;--pale:#edf3ee}:root[data-theme=dark]{--paper:#10211d;--surface:#172d27;--ink:#ecf4ed;--muted:#adbbb3;--line:#31483f;--green:#77d5bd;--accent:#ff9976;--hot:#ffb09a;--pale:#142923}header{border-color:var(--line)}details{border-radius:12px;box-shadow:0 5px 14px rgb(20 53 43 / .06)}.theme-switch-track{border-color:var(--line)}'
    )
