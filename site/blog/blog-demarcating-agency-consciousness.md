...
> Much like quantum measurement where the apparatus participates in defining the observable without needing a mystical observer, epistemic agency is shaped by its scaffolding and rules of verification, not by an unprovable private theater.

## Follow the receipts

### Research notebooks

- [Demarcating Mental-State Consciousness, Self-Consciousness, and Scaffolded Epistemic Agency](../index.html#projects/notebook:nb-higher-order-taxonomy)
...
- [source-693423395d334b51](https://api.crossref.org/works?query=artificial+agency+epistemic+normativity+metacognition&rows=4&select=DOI%2Ctitle%2Cabstract%2CURL%2Cpublished)
- [source-4f1d6569c64d4c65](https://api.crossref.org/works?query=minimal+epistemic+agency+metacognition+synthetic&rows=4&select=DOI%2Ctitle%2Cabstract%2CURL%2Cpublished)
- [source-bf2a048cc41f497a](https://api.crossref.org/works?query=%22The+Cognitive+Significance+of+Noetic+Feelings%22+%22Epistemic+Agency%22&rows=4&select=DOI%2Ctitle%2Cabstract%2CURL%2Cpublished)
